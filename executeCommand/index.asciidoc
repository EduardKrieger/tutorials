...
[step]
--
executeCommand("node", {"args": ["-v", "-h", "--help", "--a"]})
--

To use the cobigen cli you first have to install the devonfw ide. You will find more information about devonfw on https://devonfw.com/website/pages/welcome/welcome.html.
[step]
--
executeCommand("bash script.sh")
--

To use the cobigen cli you first have to install the devonfw ide. You will find more information about devonfw on https://devonfw.com/website/pages/welcome/welcome.html.
[step]
--
executeCommand("./test.ps1", {"dir": "setup/test"})
--

To use the cobigen cli you first have to install the devonfw ide. You will find more information about devonfw on https://devonfw.com/website/pages/welcome/welcome.html.
[step]
--
executeCommand("bash setup.sh", {"dir": "setup", "asynchronous": "true", "args": ["-h", "-v"]})
--
...
[step]
--
executeCommand("./localBuildTest.ps1")
--