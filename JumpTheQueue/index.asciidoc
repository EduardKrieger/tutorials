...
runClientNg("jump-the-queue/angular", { "startupTime": 200, "port": 4201, "path": "" })
--
Now the Angular Frontend Server should be running.
====
[step]
--
executeCommand("py -3 -m http.server 8100", "python3 -m http.server 8100", {"asynchronous": true}, {"port": 8001, "startupTime": 60})
--